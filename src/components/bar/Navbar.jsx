    ...
    <>
      ...
      {isOtherServicesOpen && (
        <div
          ...
          } max-w-7xl bg-gradient-to-r from-primary to-cyan-600 pb-20 shadow-lg rounded mt-8 p-4 grid grid-cols-1 w-full justify-center sm:grid-cols-2 lg:grid-cols-4 gap-4 z-30`}
          style={{ top: `${dropdownTop}px` }}
          onMouseEnter={handleDropdownMouseEnter}
          onMouseLeave={handleDropdownMouseLeave}
        >
