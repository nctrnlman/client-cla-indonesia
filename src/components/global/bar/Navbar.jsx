...
function Navbar() {
  ...
  const changeLanguage = (lng) => {
    ...
    setIsMobileMenuOpen(false); // Close the mobile menu after language change
  };
  ...
  const handleDropdownLinkClick = (to) => {
    setIsOtherServicesOpen(false);
    setIsOtherServicesMobileOpen(false);
    setIsMobileMenuOpen(false);
    navigate(to);
  };
  ...
  const toggleLanguageDropdown = () => {
    ...
    setIsMobileMenuOpen(false); // Close mobile menu when toggling language dropdown
  };
